...
public class DotBuilderTest {
    ...
    public void generateWriteWithFactory() throws IOException {
        ...
        for (final TestSet testSet : TestSets.create()) {
            ...
            DotUtils.write(nfa.getEntry(), testSet.getFactory(), String.format("target/nfa%s.dot", testSet.getClass().getSimpleName()));
        }
    }
    ...
    public void generateWriteWithoutFactory() throws IOException {
        ...
        for (final TestSet testSet : TestSets.create()) {
            ...
            DotUtils.write(dfa.getEntry(), String.format("target/dfa%s.dot", testSet.getClass().getSimpleName()));
        }
    }
